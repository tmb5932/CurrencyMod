...
import net.kwzii.currencymod.item.custom.DiceItem;
import net.kwzii.currencymod.item.custom.DoubleDiceItem;
import net.kwzii.currencymod.item.custom.FuelItem;
import net.kwzii.currencymod.item.custom.MetalDetectorItem;
