...
public class ModBlockTagGenerator extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        this.tag(ModTags.Blocks.METAL_DETECTOR_VALUABLES)
                .add(ModBlocks.SAPPHIRE_ORE.get()).add(Blocks.COPPER_ORE)
                .add(Blocks.IRON_ORE).add(Blocks.GOLD_ORE).add(Blocks.ANCIENT_DEBRIS);
...
//                .add();
        ...
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(ModBlocks.RAW_SAPPHIRE_BLOCK.get(),
                ModBlocks.SAPPHIRE_BLOCK.get(), ModBlocks.SAPPHIRE_ORE.get());
